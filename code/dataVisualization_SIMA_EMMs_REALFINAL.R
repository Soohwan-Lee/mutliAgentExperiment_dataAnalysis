...
file_base <- file.path(out_dir, "self_compliance_emm90_noBox")
ggsave(
  filename = paste0(file_base, ".pdf"),
  plot     = fig_comp
)
...
file_base <- file.path(out_dir, "self_conversion_emm90_noBox")
ggsave(
  filename = paste0(file_base, ".pdf"),
  plot     = fig_conv
)
...
file_base <- file.path(out_dir, "agent_perception_emm90_noBox")
ggsave(
  filename = paste0(file_base, ".pdf"),
  plot     = fig_agent
)
